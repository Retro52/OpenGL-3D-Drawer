...
void MainLoop::Initialize()
{
    ...
    {
        throw EngineException("Error during program initialization. Reason: " + std::string(e.what()));
    }
...
double MainLoop::GetWorldDeltaTime()
{
    return deltaTime;
}
...
unsigned long MainLoop::GetTotalFrames()
{
    return totalFrames;
}